export default {
  common: { search: '검색', create: '추가', edit: '편집', delete: '삭제', save: '저장', cancel: '취소', confirm: '확인', actions: '작업', status: '상태', enabled: '활성', disabled: '비활성', yes: '예', no: '아니오', success: '성공', failed: '실패', view: '보기' },
